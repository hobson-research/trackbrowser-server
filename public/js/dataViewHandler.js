function DataViewHandler() {
	...
	var addItem = function(activity) {
		...
		if (activity.type === "navigation") {
			...
			newItemInnerHTML += '<p>User typed "' + activity.inputValue + '" into an ' + activity.inputType + ' element (id: ' + activity.inputId + ', name: ' + activity.inputName + ' ) in <a href="' + activity.url + '">' + activity.url + '</a>.</p>';
		}
